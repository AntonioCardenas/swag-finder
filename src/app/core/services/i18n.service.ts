...
const EN = {
  ...
  swag: {
    ...
    peopleClaimed: 'claimed',
    lastClaimed: 'last',
    youClaimed: 'You claimed this',
    warnAlreadyYours: 'You already claimed this one!',
    warnUnavailable: 'This swag may have already been taken or removed.',
  },
  create: {
    title: 'Add Swag',
    backAriaLabel: 'Back',
...
const ES: Translations = {
  ...
  swag: {
    ...
    peopleClaimed: 'reclamado',
    lastClaimed: 'último',
    youClaimed: 'Ya lo tienes',
    warnAlreadyYours: '¡Ya reclamaste este swag!',
    warnUnavailable: 'Este swag puede que ya no esté disponible.',
  },
  create: {
    title: 'Agregar Swag',
    backAriaLabel: 'Atrás',
